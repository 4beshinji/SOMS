    ...
    <div className="flex items-center justify-center min-h-screen p-6">
      <div className="w-full max-w-xs space-y-6 text-center">
        <div>
          ...
          <p className="text-gray-400 mt-2 text-sm">Sign in to get started</p>
        </div>

        <div className="space-y-3">
          <button
            onClick={() => login('slack')}
            className="w-full py-3 bg-[#4A154B] hover:bg-[#611f64] text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors"
          >
          ...
          <button
            ...
            className="w-full py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-gray-600 text-xs">
          By signing in, you agree to the SOMS terms of use.
        </p>
      </div>
    </div>
  );
