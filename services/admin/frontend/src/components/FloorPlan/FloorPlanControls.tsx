import type { FloorPlanLayer, ZoneGeometry, LiveSpatialData } from '@soms/types';
        ...
        {editMode && (
          <div className="mt-3 space-y-2">
            <input
              ...
              placeholder="Device ID (e.g. env_01)"
            ...
            <p className="text-[10px] text-[var(--gray-400)]">
              Click on floor plan to place / right-click to delete
            </p>
          </div>
        )}
      </div>
