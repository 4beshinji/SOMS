...
import type { DevicePositionResponse, FloorPlanLayer, ZoneGeometry } from '@soms/types';
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-[var(--gray-600)] mt-4">Loading floor plan...</p>
        </div>
      </div>
    );
  }
  ...
  if (!config) {
    return (
      <div className="text-center py-12">
        <p className="text-[var(--gray-500)] text-lg">Spatial configuration not found</p>
        <p className="text-[var(--gray-400)] text-sm mt-2">Please create config/spatial.yaml</p>
      </div>
    );
  }
